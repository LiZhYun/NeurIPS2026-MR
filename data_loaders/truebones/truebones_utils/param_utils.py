...
# V3 benchmark held-out skeletons (added 2026-04-18 for honest cross-skeleton eval)
# These 10 skeletons are EXCLUDED from train_v3 subset for clean held-out evaluation.
V3_TEST_SKELETONS = ["Cat", "Elephant", "Spider", "Crab", "Trex",
                     "Raptor", "Buzzard", "Alligator", "Anaconda", "Rat"]
_ALL_SKELETONS = QUADROPEDS + BIPEDS + MILLIPEDS + SNAKES + FISH + FLYING

OBJECT_SUBSETS_DICT = {"all" : _ALL_SKELETONS,
                       ...
                       "all_clean": [obj for obj in _ALL_SKELETONS if obj not in CONNECTED_TO_GROUND],
                       # V3 train subset: excludes 10 held-out skeletons for clean eval
                       "train_v3": [obj for obj in _ALL_SKELETONS if obj not in V3_TEST_SKELETONS],
                       "test_v3": V3_TEST_SKELETONS,
                       }
